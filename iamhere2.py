...
# -------- FIX 1: Use absolute directories (prevents “saved here, served there” madness) --------
...
# -------- FIX 2: send_file compatibility wrapper (Flask 1.x vs 2.x) --------
                ...
                with rasterio.open(filepath) as src:
                    ...
                    if src.crs:
                        ...
                        if epsg != 4326:
                            ...
                            print("Using original bounds (already WGS84)")
                    else:
                        info['bounds'] = None
                        print("No CRS found: cannot compute WGS84 bounds safely")
...
# -------- FIX 3: safer filename and send_file compat --------
@app.route('/preview/<path:filename>')
def serve_preview(filename):
    filename = os.path.basename(filename)  # strips any path traversal junk
...
# -------- Bonus: a debug endpoint so you stop guessing --------
